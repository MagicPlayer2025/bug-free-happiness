...
<body>
    ...
    <!-- Сайдбар -->
            <div class="col-md-2 p-3 sidebar-admin">
                ...
                <li class="nav-item">
                    <a class="nav-link  nav-link-active" href="admin-discount.php">Акции</a>
                </li>
                <li class="nav-item">
    ...
    <!-- Основной контент -->
         <div class="col-md-10 p-3">
             ...
             <?php endif; ?>
             <form method="POST" action="/assets/vendor/admin/add-discount.php" class="compact-form">
                <div class="form-row">
                    <input type="text" name="name" placeholder="Название" required>
                    <input type="text" name="description" placeholder="Описание">
                    <input type="text" name="date" placeholder="Дата (действия)">
                ...
                <tbody>
                    <?php foreach ($discounts as $discount) { ?>
                        <tr class="tr-base">
                            ...
                            <td><img src="../<?php echo htmlspecialchars($discount['img']) ?>" alt=""></td>
                            <td>
                            <td>
                                <div class="admin-btn">
                                
                                <a href="/assets/vendor/admin/edit-discount.php?id=<?php echo $discount['ID']; ?>" class="insert-btn">Редактировать</a>
                                
                                <form method="POST" action="/assets/vendor/admin/delete-discount.php" class="delete-form d-inline">
