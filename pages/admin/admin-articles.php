...
<body>
            ...
            <div class="col-md-2 p-3 sidebar-admin">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                      <a class="nav-link nav-link-active" href="admin-articles.php">Статьи</a>
                 </li>
                    <li class="nav-item">
    ...
    <!-- Основной контент -->
         <div class="col-md-10 p-3">
             ...
             <?php endif; ?>
             <form method="POST" action="/assets/vendor/admin/add-articles.php" class="compact-form">
                <div class="form-row">
                ...
                <tbody>
                    <?php foreach ($articles as $article) { ?>
                        <tr class="tr-base">
                            ...
                            <td><img src="../<?php echo htmlspecialchars($article['img']) ?>" alt=""></td>
                            
                            <td>
                                <div class="admin-btn">
                                    <a href="/assets/vendor/admin/edit-article.php?id=<?php echo $article['ID']; ?>" class="insert-btn ">Редактировать</a>
                                    <form method="POST" action="/assets/vendor/admin/delete-article.php" class="delete-form d-inline">
