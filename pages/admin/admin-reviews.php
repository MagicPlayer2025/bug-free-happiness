...
<body>
    ...
    <!-- Сайдбар -->
            <div class="col-md-2 p-3 sidebar-admin">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                     <a class="nav-link nav-link-active " href="admin-reviews.php">Отзывы</a>
                 </li>
                <li class="nav-item">
    ...
    <!-- Основной контент -->
         <div class="col-md-10 p-3">
             ...
             <?php endif; ?>
             <form method="POST" action="/assets/vendor/admin/add-reviews.php" class="compact-form">
                <div class="form-row">
                    <input type="text" name="name" placeholder="Название" required>
                    <input type="text" name="comment" placeholder="Коментарий">
                   <select name="rating" required>
                        <option style="color:gray;" value="" disabled selected>Выберите оценку</option>
                        <option style="color:red;" value="1">1</option>
                        <option style="color:#FF4500;" value="2">2</option>
                        <option style="color:#FFFF00;" value="3">3</option>
                        <option style="color:#ADFF2F;" value="4">4</option>
                        <option style="color:#00FF00;" value="5">5</option>
                    </select>
                    ...
                    <?php foreach ($reviews as $review) { ?>
                        <tr class="tr-base">
                            ...
                            <td>
                                ...
                                <a href="/assets/vendor/admin/edit-review.php?id=<?php echo $review['ID']; ?>" class="insert-btn">Редактировать</a>
                                
                                <form method="POST" action="/assets/vendor/admin/delete-review.php" class="delete-form d-inline">
