...
<div class ="people">
    <div class="people_osnova">
        ...
        <h2>Данияр</h2>
        <p>Отвечал за вёрстку, пользовательский <br> интерфейс и адаптацию под разные <br> устройства.</p>
    </div>
        <div class="people_osnova">
        <h1>Backend-разработчик</h1>
        <h2>Ильназ</h2>
        <p>Реализовал серверную логику, базы данных и обработку заявок.</p>
    </div>
            <div class="people_osnova">
        <h1>Проект-менеджер</h1>
        <h2>Марсель</h2>
        <p>Координировал процесс работы,  и контролировал соблюдение сроков.</p>
    </div>
            <div class="people_osnova">
        <h1>Дизайнер</h1>
        <h2>Дмитрий</h2>
